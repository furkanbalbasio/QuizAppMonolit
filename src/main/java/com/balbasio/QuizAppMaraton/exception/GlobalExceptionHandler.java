...
import static com.balbasio.QuizAppMaraton.exception.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(QuizAppMaratonException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleMonolitSpotifyException(QuizAppMaratonException exception){
